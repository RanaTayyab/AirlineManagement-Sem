...
<%-- 
    Document   : index
    Created on : Oct 27, 2017, 9:50:36 PM
    Author     : Tayyab
--%>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8 d-none d-lg-block">
              <h1 class="display-4">Book your <strong>Airline Flights</strong> with The Best System.</h1>
            ...
            <div class="col-lg-4">
              <div class="card bg-primary text-center card-form">
                <div class="card-body">
                  ...
                  <form action="DisplayFlightsUnknown.jsp">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-lg" placeholder="Departure">
                    </div>
                    <div class="form-group">
                      <input type="text" class="form-control form-control-lg" placeholder="Arrival">
                    </div>
					<div class="form-group">
					<input type="date" class="form-control form-control-lg" id="date" name="date" size="20"required />
					</div>
                    <div class="form-group">
					  ...
					  <div class="form-row mb-3">
						<div class="col">
						  <input type="text" class="form-control form-control-lg " placeholder="Adults">
						</div>
						<div class="col">
						  <input type="text" class="form-control form-control-lg" placeholder="Children">
