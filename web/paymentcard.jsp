<%-- 
    Document   : paymentcard
    Created on : Nov 6, 2017, 10:13:08 PM
    Author     : Tayyab
--%>
        ...
        <div class="container py-5">
          <div class="row">
            <div class="col-lg-5 d-none d-lg-block">
              <h1 class="display-4">Your <strong>Payment</strong> Card.</h1>
			  ...
			  <br><br><br><br><br>
              	<a href="Payment.jsp" class="btn btn-success " role="button">< Go Back</a>
            </div>
            <div class="col-lg-7">
              <div class="card bg-success text-center card-form">
                <div class="card-body">
                  <h3>Payment</h3>
                  <p>Please fill out this form for paying the bill</p>
                  <form action="invoice.jsp" method="post">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-lg" placeholder="Name on Card" autofocus required>
                    </div>
                    <div class="form-group">
                      <input type="text" class="form-control form-control-lg" placeholder="Card No." required>
                    </div>
					<div class="form-group">
					<input type="date" class="form-control form-control-lg" id="date" name="date" size="20" required/>
					  ...
					  -->
						<input type="submit" value="Pay the Bill" class="btn btn-outline-light btn-block">
                  </form>
                </div>
              </div>
            </div>
