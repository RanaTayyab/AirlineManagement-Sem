...
<%-- 
    ...
    Created on : Nov 6, 2017, 11:20:46 PM
    Author     : Tayyab
--%>
...
function compare()
{
    var w = document.forms["DeleteAdminForm"]["dates"].value;
    var startDate = new Date(w);
    var endDate = new Date();

    if (startDate.getTime() < endDate.getTime())
    {
         document.forms["DeleteAdminForm"]["dates"].value="";
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-5 d-none d-lg-block">
              <h1 class="display-4">Admin Panel - <strong>Delete Flights</strong> with The Best System.</h1>
            ...
            <div class="col-lg-7 py-5">
              <div class="card bg-primary text-center card-form">
                <div class="card-body">
                  <h3>Delete the Flights</h3>
                  <p>Please fill out this form for deleting the flights.</p>
                  <form name="DeleteAdminForm"  method="post" action="AdminDeleteController">
				  
				  <div class="form-group">
                                      <input type="text" name="flightno" class="form-control form-control-lg" placeholder="Old Flight No." autofocus required>
                    </div>
					
					
					<div class="form-group">
					<input type="date" class="form-control form-control-lg" id="date" name="dates" size="20"required onblur="compare(this)"/>
					</div>
					  ...
					  -->
						<input type="submit" value="Delete Flight" class="btn btn-outline-light btn-block">
                  </form>
                </div>
              </div>
            </div>
