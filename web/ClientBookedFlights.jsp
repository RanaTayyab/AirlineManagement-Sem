...
<%-- 
    Document   : ClientBookedFlights
    Created on : Nov 6, 2017, 10:21:54 PM
    Author     : Tayyab
--%>
...
<head>
  ...
  <link rel="stylesheet" href="css/stylebooked.css">
    ...
    <div class="dark-overlay">
      <div class="home-inner">
        <div class="container">
              ...
              <h1 class="display-4 py-5" ><strong>Flight Booked Successfully</strong>.</h1>
              ...
              <div class="d-flex flex-row">
				...
				You have successfully booked your desired flight.
			  ...
			  <div class="d-flex flex-row">
                ...
                <div class="p-4 align-self-end">
				Check your Email for Invoice too.
						<h1 class="display-3 py-5" ><strong>Thankyou!</strong></h1>
					</div>
              </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
			...
			<a href="profile.html" class="btn btn-primary btn-block" role="button">Login</a>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
		 ...
		 <div class="form-group">
			...
			<div class="modal-footer">
          <a href="index.html" class="btn btn-primary btn-block" role="button">Register</a>
          </div>
        </div>
      </div>
    </div>
