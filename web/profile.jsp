...
<%-- 
    Document   : profile
    Created on : Oct 28, 2017, 8:42:07 PM
    Author     : Tayyab
--%>
...
function compare()
{
    var w = document.forms["myProfileForm"]["dates"].value;
    var startDate = new Date(w);
    var endDate = new Date();

    if (startDate.getTime() < = endDate.getTime())
    {
         document.forms["myProfileForm"]["dates"].value="";
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8 d-none d-lg-block">
              <h1 class="display-4">Welcome Back! <br>Book your <strong>Airline Flights</strong> with The Best System.</h1>
              ...
              <div class="d-flex flex-row">
                ...
                <div class="p-4 align-self-end">
				Now customers enjoy 3,000 bonus Skywards Miles when they book their first stay at over 400,000 hotels worldwide with our partner Rocketmiles. </div>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="card bg-primary text-center card-form">
                <div class="card-body">
                  ...
                  <p>Please fill out this form for booking</p>
                  <form name="myProfileForm"  method="post" action="ProfileController">
                    <div class="form-group">
                        <input type="text" name="departure" class="form-control form-control-lg" placeholder="Departure" required autofocus onblur="allLetter(this)">
                    </div>
                    <div class="form-group">
                      <input type="text" name="arrival" class="form-control form-control-lg" placeholder="Arrival" required onblur="allLetter(this)">
                    </div>
					<div class="form-group">
					<input type="date" class="form-control form-control-lg" id="date" name="dates" id="dates" size="20"required onblur="compare(this)"/>
					</div>
                    <div class="form-group">
						<select  class="form-control form-control-lg" name="selectclass" required >
					  ...
					  <div class="form-row mb-3">
						<div class="col">
						  <input type="text" name="adults" class="form-control form-control-lg " placeholder="Adults" required onblur="allnumeric(this)"/>
						</div>
						<div class="col">
						  <input type="text" name="children" class="form-control form-control-lg" placeholder="Children" required onblur="allnumeric(this)"/>
					  ...
					  -->
						<input type="submit" value="Check Availability" class="btn btn-outline-light btn-block">
                  </form>
                </div>
              </div>
            </div>
