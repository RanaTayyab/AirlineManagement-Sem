...
<%-- 
    Document   : DisplayFlightsUnknown
    Created on : Oct 27, 2017, 10:47:13 PM
    Author     : Tayyab
--%>
     ...
     <h1 class="display-4">List of <strong>Available Searched Flights</strong>.</h1>
        <tr>
            ...
            <tr>
				...
				<td>02:00 P.M.</td>
				<td>80,000 PKR</td>
                <td class="text-center"><a class='btn btn-success btn-md' href="login.jsp"><span class="glyphicon glyphicon-edit"></span> Book</a> <a href="login.jsp" class="btn btn-danger btn-md"><span class="glyphicon glyphicon-remove"></span> Unbook</a></td>
            </tr>
            <tr>
                <td>PK203</td>
                <td>Lahore</td>
