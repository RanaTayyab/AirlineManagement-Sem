...
<%-- 
    ...
    Created on : Nov 6, 2017, 11:08:07 PM
    Author     : Tayyab
--%>
...
function compare()
{
    var w = document.forms["UpdateAdminForm"]["dates"].value;
    var startDate = new Date(w);
    var endDate = new Date();

    if (startDate.getTime() < endDate.getTime())
    {
         document.forms["UpdateAdminForm"]["dates"].value="";
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-5 d-none d-lg-block">
              <h1 class="display-4">Admin Panel - <strong>Update Flights</strong> with The Best System.</h1>
            ...
            <div class="col-lg-7">
              <div class="card bg-primary text-center card-form">
                <div class="card-body">
                  <h3>Update the Flights</h3>
                  <p>Please fill out this form for updating the flights.</p>
                  <form name="UpdateAdminForm"  method="post" action="AdminUpdateController">
		<div align="center" style="color:gold;font-size:18px">${perror}</div>    
				  <div class="form-group">
                      <input type="text" name="flightno" class="form-control form-control-md" placeholder="Old Flight No." required autofocus>
                    </div>
					
					
					 <div class="form-row mb-3">
						<div class="col">
						  <input type="text" name="arrival" class="form-control form-control-md " placeholder="Update Arrival" onblur="allLetter(this)">
						</div>
						<div class="col">
						  <input type="text" name="departure" class="form-control form-control-md" placeholder=" Update Departure" onblur="allLetter(this)">
					   ...
					   <div class="form-row mb-3">
						...
						<div class="col">
				  <input type="time"  class="form-control form-control-md" name="time">
				  ...
				  <div class="form-row mb-3">
						<div class="col">
						  <input type="text" name="economyseat"  class="form-control form-control-md " placeholder="Update Economy Class Seats">
						</div>
						<div class="col">
						  <input type="text" name="economyprice" class="form-control form-control-md" placeholder="Update Economy Price">
					  ...
					  <div class="form-row mb-3">
						<div class="col">
						  <input type="text" name="businessseat" class="form-control form-control-md " placeholder="Update Business Class Seats">
						</div>
						<div class="col">
						  <input type="text" name="businessprice" class="form-control form-control-md" placeholder="Update Business Price">
					  ...
					  <div class="form-row mb-3">
						<div class="col">
						  <input type="text" name="firstseat" class="form-control form-control-md " placeholder="Update First Class Seats">
						</div>
						<div class="col">
						  <input type="text" name="firstprice" class="form-control form-control-md" placeholder="Update First Class Price">
					  ...
					  -->
						<input type="submit" value="Update Flight" class="btn btn-outline-light btn-block">
                  </form>
                </div>
              </div>
            </div>
